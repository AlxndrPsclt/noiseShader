...
vec2 point(vec2 uv, float time, float size) {  //size = 10.0
  ...
  float px1 = floor(SURFACE_COLUMNS*noise(m.x*time));
  float py1 = floor(SURFACE_COLUMNS*noise(m.y*cos(time)));
...
//
  ...
  for(float i = 0.0; i < 100.0; i += 4.0) { // you can also play with these iteration counts
    newPoint = point(uv,u_time-i*0.01,200.0/(abs(log(100.0-2.0*i))));
    d += newPoint.x*newPoint.y;
  };
  for(float i = 0.0; i < 100.0; i += 4.0) { // you can also play with these iteration counts
    newPoint = point(uv,u_time-2.0-i*0.01,200.0/(abs(log(100.0-2.0*i))));
    d += newPoint.x*newPoint.y;
  };
  for(float i = 0.0; i < 100.0; i += 4.0) { // you can also play with these iteration counts
    newPoint = point(uv,u_time-3.0-i*0.01,200.0/(abs(log(100.0-2.0*i))));
    d += newPoint.x*newPoint.y;
  };
  for(float i = 0.0; i < 100.0; i += 4.0) { // you can also play with these iteration counts
    newPoint = point(uv,u_time-7.7-i*0.01,200.0/(abs(log(100.0-2.0*i))));
    d += newPoint.x*newPoint.y;
  };
  for(float i = 0.0; i < 100.0; i += 4.0) { // you can also play with these iteration counts
    newPoint = point(uv,u_time-9.1-i*0.01,200.0/(abs(log(100.0-2.0*i))));
    d += newPoint.x*newPoint.y;
  };
  for(float i = 0.0; i < 100.0; i += 4.0) { // you can also play with these iteration counts
    newPoint = point(uv,u_time-10.0-i*0.01,200.0/(abs(log(100.0-2.0*i))));
    d += newPoint.x*newPoint.y;
  };
  for(float i = 0.0; i < 100.0; i += 4.0) { // you can also play with these iteration counts
    newPoint = point(uv,u_time-12.0-i*0.01,200.0/(abs(log(100.0-2.0*i))));
    d += newPoint.x*newPoint.y;
  };
  for(float i = 0.0; i < 100.0; i += 4.0) { // you can also play with these iteration counts
    newPoint = point(uv,u_time-13.0-i*0.01,200.0/(abs(log(100.0-2.0*i))));
    d += newPoint.x*newPoint.y;
  };
